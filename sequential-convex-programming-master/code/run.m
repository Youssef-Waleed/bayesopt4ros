...
scenarios(41) = config.scenario_race_various_vehicles(scenarios(1));
...
if nargin == 0 % default: run only selected scenario
    output_file = sim.run(scenarios(41));
    %for more racers uncomment last lines in the
    %scenario_race_various_vehicles file
    
    % Loading saved file after finished scenario
